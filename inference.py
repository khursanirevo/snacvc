#!/usr/bin/env python3
"""
Phase 10 Inference: Evaluate reconstruction quality on custom data.

Tests L1 and STFT reconstruction losses on audio files from specified directories.
Phase 10 is simple SNAC fine-tuning (no speaker conditioning, no adapters).
...
def load_model(checkpoint_path, device):
    """Load Phase 10 fine-tuned model."""
...
def main():
    parser = argparse.ArgumentParser(description="Phase 10 Inference - Compare Base vs Fine-tuned")
